...
static const Key keys[] = {
	...
	{ MODKEY|Mod1Mask,              XK_x,      incrohgaps,     {.i = -5 } },
	...
	{ MODKEY|ShiftMask,		XK_n,      spawn,	   SHCMD("firejail --apparmor firefox") },
	{ MODKEY|ShiftMask,		XK_c,      spawn,	   SHCMD("firejail --apparmor firefox web.whatsapp.com") },
	{ MODKEY,			XK_c,      spawn,	   SHCMD("firejail torbrowser-launcher") },
	...
	{ 0,				XF86XK_MyComputer,          spawn,	   SHCMD("kill -39 $(pidof goblocks)") },
};
